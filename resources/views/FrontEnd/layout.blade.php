                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
                            @if (Route::currentRouteName() == 'shopindex')
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('cart') }}" class="site-cart">
                                            ...
                                            <span
                                                class="count">{{ session()->get('cartItems') == null ? '0' : count(session()->get('cartItems')) }}
                                            </span>
                                        </a>
                                    </li>
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
                <div class="container">
                    <ul class="site-menu js-clone-nav d-none d-md-block">
                        ...
                        <li
                            class="{{ request()->segment(2) === null ? (Route::currentRouteName() === 'shopindex' ? 'active' : '') : '' }}">
                            <a href="{{ route('shopindex') }}">Shop</a>
                        </li>
                        @foreach ($categoriesAsWhole as $category)
                            <li class="{{ request()->segment(2) === "$category->name" ? 'active' : '' }}">
                                <a href="{{ route('shopindex', $category->name) }}">{{ $category->name }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                        ...
                        <a href="#" class="block-6">
                            <img src="{{ asset('FrontEnd/images/hero_1.jpg') }}" alt="Image placeholder"
