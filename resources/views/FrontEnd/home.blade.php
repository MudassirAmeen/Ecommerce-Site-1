...
@section('main')
    <div class="site-blocks-cover" id="hero-section" data-aos="fade">
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-end">
                <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                    ...
                    <div class="intro-text text-center text-md-left">
                        ...
                        <p>
                            <a href="{{ route('shopindex') }}" class="btn btn-sm btn-primary">Shop Now</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                    <a class="block-2-item" href="{{ route('shopindex', ['category' => 'women']) }}">
                        <figure class="image">
                            <img src="{{ asset('FrontEnd/images/women.jpg') }}" alt="Category" class="img-fluid">
                        </figure>
                        <div class="text">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                    <a class="block-2-item" href="{{ route('shopindex', 'boy') }}">
                        <figure class="image">
                            <img src="{{ asset('FrontEnd/images/children.jpg') }}" alt="Category" class="img-fluid">
                        </figure>
                        <div class="text">
                            <span class="text-uppercase">Collections</span>
                            <h3>Children</h3>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                    <a class="block-2-item" href="{{ route('shopindex', 'men') }}">
                        <figure class="image">
                            <img src="{{ asset('FrontEnd/images/men.jpg') }}" alt="Category" class="img-fluid">
                        </figure>
                        <div class="text">
                            <span class="text-uppercase">Collections</span>
                            <h3>Men</h3>
                    ...
                    <div class="nonloop-block-3 owl-carousel">
                        @foreach ($products as $product)
                            @php
                                ...
                                $name = \Illuminate\Support\Str::limit($product->name, 20, '...');
                            @endphp
                            <div class="item">
                                <div class="block-4 text-center">
                                    <figure class="block-4-image">
                                        <img src="{{ asset('storage/images/' . $imageUrl) }}" alt="Image placeholder"
                                            class="img-fluid">
                                    </figure>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="{{ asset('FrontEnd/images/blog_1.jpg') }}" alt="Image placeholder"
...
@section('footer')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var imageUrl = '{{ asset('FrontEnd/images/hero_1.jpg') }}';
