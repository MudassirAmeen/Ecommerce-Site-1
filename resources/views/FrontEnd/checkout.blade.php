...
@section('main')
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="{{ route('FrontEnd') }}">Home</a> <span class="mx-2 mb-0">/</span> <a
    ...
    <div class="site-section">
        <div class="container">
            ...
            <form action="{{ route('adminDashboard') }}" style="display: contents">
            <div class="row">
                    <div class="col-md-6 mb-5 mb-md-0">
                        ...
                        <div class="p-3 p-lg-5 border">
                            ...
                            <button type="submit" id="checkoutFormSUbmisstion" style="display: none"></button>
                        </div>
                    </div>
                <div class="col-md-6">
                    <div class="row mb-5">
                        <div class="col-md-12">
                            ...
                            <div class="p-3 p-lg-5 border">
                                    <form action="{{ route('checkCoupon') }}" method="POST"
                                        style="display:contents" id="innerForm">
                                    ...
                                    <div class="input-group w-75">
                                        ...
                                        <input type="text" class="form-control" id="c_code"
                                            placeholder="Coupon Code" aria-label="Coupon Code" name='code'
                                            aria-describedby="button-addon2">
                                        </div>
                                        <div class="input-group-append">
                                            <button class="btn btn-primary btn-sm"
                                                type="button"onclick="submit()"id="button-addon2">Apply</button>
                                    </div>
                                </form>
                                    <script>
                            ...
                            <div class="p-3 p-lg-5 border">
                                <table class="table site-block-order-table mb-5">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cartItems as $item)
                                            <tr>
                                                <td><a href="{{ route('single', $item->id) }}" style="color:inherit"
                                                        target="_blank">{{ $item->name }}</a> <strong
                                        ...
                                        @if (session()->has('coupon'))
                                            <tr>
                                                ...
                                                <td class="text-black font-weight-bold">
                                                    <strong>${{ session()->get('coupon') }}</strong>
                                                </td>
                                            </tr>
                                        @endif
                                        <tr>
                                            ...
                                            <td class="text-black font-weight-bold">
                                                <strong>${{ session()->get('totalPrice') }}</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary btn-lg py-3 btn-block"
                                        onclick="document.getElementById('checkoutFormSUbmisstion').click()">Place
                                        Order</button>
                                </div>
